  ...
  return (
    ...
    >
      <div className="p-6 border-b border-gray-100 flex items-center justify-between">
        {!isCollapsed && (
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Bbbbbbbbbbb</p>
      ...
      <div className="p-4 border-t border-gray-100 space-y-2">
        ...
        <button className="flex items-center space-x-3 px-4 py-3 w-full text-left text-red-600 hover:bg-red-50 rounded-xl transition-colors mt-2">
          <LogOut size={20} />
